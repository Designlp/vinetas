...
<div class="container-fluid">
	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-5" href="lista_usuarios.php">
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">S. ADMINISTRADORES</div>
							
							
							<div class="h5 mb-0 font-weight-bold text-gray-800">
							<?php
            					include "../conexion.php";
            			     		 $query = mysqli_query($conexion, "SELECT count(*) as total FROM  usuario WHERE IDRol=1");
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-3 col-md-6 mb-5" href="lista_cliente.php">
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<?php
            					include "../conexion.php";
            			     		 $query = mysqli_query($conexion, "SELECT count(*) as total FROM  usuario WHERE IDRol=3");
					    			while ($data = mysqli_fetch_assoc($query)) {
									 echo $data['total'];
								 } 
					           	 ?>
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-3 col-md-6 mb-5" href="lista_lecciones.php">
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<?php
            					include "../conexion.php";
            			     		 $query = mysqli_query($conexion, "SELECT count(*) as total FROM  usuario WHERE IDRol=4");
					    			while ($data = mysqli_fetch_assoc($query)) {
									 echo $data['total'];
								 } 
					           	 ?>
		...
		<!-- Pending Requests Card Example success -->
		<a class="col-xl-3 col-md-6 mb-5" href="lista_lecciones.php">
			<div class="card border-left-success shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">GUARDIAS</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800">
							<?php
            					include "../conexion.php";
            			     		 $query = mysqli_query($conexion, "SELECT count(*) as total FROM  usuario WHERE IDRol=5");
					    			while ($data = mysqli_fetch_assoc($query)) {
									 echo $data['total'];
								 } 
					           	 ?>
