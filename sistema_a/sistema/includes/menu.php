		...
		<li class="nav-item">
			...
			<div id="collapseUsuarios" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="registro_usuario.php">Nuevo Empleado/Usuario</a>
					<a class="collapse-item" href="registro_dependencia1x.php">Contratar Empleado</a>
					<a class="collapse-item" href="registro_dependencia2x.php">Contratar Pasante</a>
				    <a class="collapse-item" href="registro_dependencia3x.php">Contratar Guardia</a>
